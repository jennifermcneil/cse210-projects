...
public class EternalQuest
{
    ...
    public void AddGoal()
    {
        ...
        switch (userInput)
        {
            ...
            case 3:
                ...
                int goalChecks = Convert.ToInt32(Console.ReadLine());
                ...
                Checklist checklist = new Checklist(goalName, goalDesc, goalPoints, goalChecks, goalBonus);
    ...
    public void DisplayGoal()
    {
        ...
        {
            Console.WriteLine($"{i + 1}. [{userGoals[i].GetIsComplete()}] {userGoals[i].GetName()} ({userGoals[i].GetDescription()}) call getCompleted mthod");
        }

    }
    public void RemoveGoal()
    {
        // Display all goals with numbers (call display goal)
        // prompt user for the goal number they want to remove
        // use the .remove method on the userGoal list to remove item (number - 1)
    }
}